...
public class NoticesceneController implements Initializable {
    ...
    @FXML
    private TextArea CreateNoticeTextArea;
    @FXML
    private TextArea CheckNoticeTextArea;
    ...
    @FXML
    private void CheckNoticeButtonOnClick(ActionEvent event) {
    }
    ...
    @FXML
    private void SelectDepartmentButtonOnClick(ActionEvent event) {
    }
